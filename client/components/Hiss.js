    ...
    return (
      ...
      >
        ...
        <View style={{ marginLeft: 10 }}>
          ...
          <Text style={{ fontSize: 18, marginVertical: 7 }}>
            {item.content}
          </Text>
          <View
            style={{
            ...
            {route === "Home" ||
              ...
              <>
                <TouchableOpacity
                  ...
                  onPress={() => handleReply(item.User.id)}
                >
                  <FontAwesome name="comment-o" size={18} color="black" />
                </TouchableOpacity>
                <TouchableOpacity
                  style={{ marginLeft: 50, flexDirection: "row" }}
                  onPress={() => handleLike(item.id)}
                >
                  <AntDesign
                    name={
                      item.Likes.filter((el) => el.UserId == id).length
                        ? "heart"
                        : "hearto"
                    }
                    size={18}
